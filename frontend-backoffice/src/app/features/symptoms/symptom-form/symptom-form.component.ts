...
const MOCK_SYMPTOMS: Symptom[] = [
  {
    ...
    symptomDetail: "Sentiment persistant d'inquiétude",
  ...
  },
  {
    ...
    symptomDetail: "Difficulté à s'endormir",
  ...
  },
  {
    ...
    symptomDetail: 'Maux de tête intenses',
  ...
  },
  {
    ...
    symptomFamily: 'Troubles nerveux',
    symptomDetail: 'Épuisement persistant',
...
export class SymptomFormComponent implements OnInit {
  ...
  get title() {
    return this.symptomForm.get('title');
  }
  get family() {
    return this.symptomForm.get('family');
  }
  get description() {
    return this.symptomForm.get('description');
  }
